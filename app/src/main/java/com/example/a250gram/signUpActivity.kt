...
import com.example.a250gram.databinding.ActivitySignUpBinding
import com.example.a250gram.utils.USER_NODE
import com.example.a250gram.utils.USER_PROFILE_FOLDER
import com.example.a250gram.utils.uploadImage
...
class signUpActivity : AppCompatActivity() {
    ...
    private val launcher = registerForActivityResult(ActivityResultContracts.GetContent()) { uri ->
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding.addImage.setOnClickListener { launcher.launch("image/*") }
